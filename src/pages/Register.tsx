    ...
    useEffect(() => {
        ...
        style.innerHTML = `
          ion-content {
            ...
            background-image: url('https://img.freepik.com/premium-vector/vertical-background-with-smooth-gradient-vector-illustration_522680-306.jpg?semt=ais_hybrid&w=740');
